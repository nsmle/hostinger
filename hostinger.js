...
const TLDS = [
  {
    ...
    tlds: ["ad","ag","ai","am","an","aq","as","aw","ax","az","bd","be","bf","bg","bi","bj","bm","bt","bv","bw","by","cc","cd","cf","cg","ch","ci","cl","cm","cu","cv","cx","cz","de","dj","dk","dm","ee","eu","fi","fm","fo","ga","gb","gd","ge","gf","gi","gl","gm","gp","gq","gs","gw","gy","hm","hn","hr","ht","hu","ie","im","io","is","jm","kg","kp","la","lc","li","ls","lt","lu","md","mh","mm","mp","mq","mr","ms","nc","ne","nl","no","nu","pf","pg","pm","pn","si","sj","sk","sm","so","sr","su","tc","td","tf","tg","tk","tl","tm","to","tp","tv","uz","va","vc","vg","vu","wf","ws","yt","zw"],
  }
]
